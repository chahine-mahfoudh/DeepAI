...
import {signOut} from '../../../../app/store/reducers/authReducer'
...
const HeaderUserMenu: FC = () => {
  ...
  return (
        ...
        <div className='menu-content d-flex align-items-center px-3'>
          ...
          <div className='d-flex flex-column'>
            <div className='fw-bolder d-flex align-items-center fs-5'>
              ...
              <span className='badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2'>Free</span>
            </div>
    ...
    { isAuthenticated && <div className='menu-item px-5'>
